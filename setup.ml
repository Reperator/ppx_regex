...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5f3c26bc1c21a041876f2fe04c8e5e6d) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          bugreports = None;
          synopsis =
            "OCaml Preprocessor for matching with regular expressions";
          description =
            Some
              [
                 OASISText.Para
                   "OCaml Preprocessor to allow regular expressions in pattern matchings"
              ];
          tags = [];
          categories = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ppx_regex.ml"})
            ];
               ...
               pre_command =
                 [
                    (OASISExpr.EBool true,
                      Some
                        (("$ocamlfind", ["install"; "ppx_regex"; "lib/META"])))
                 ];
               post_command = [(OASISExpr.EBool true, None)]
            };
          uninstall_custom =
            {
               pre_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("$ocamlfind", ["remove"; "ppx_regex"])))
                 ];
               post_command = [(OASISExpr.EBool true, None)]
            };
          clean_custom =
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "$\\(\017;\015\233\137\163l\t\226\142\179\208\b";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
